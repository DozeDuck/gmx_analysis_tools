...
class gmx_dssp():
    ...
    def plot_ss_percentage(self, df, structure_values, original, outputname, color):
        # 计算二级结构百分比
        ss_percentage = self.calculate_ss_percentage(df, structure_values, color)
        ...
        # 显示百分比图
        pio.write_image(fig_ss_percentage, "percentage-" + outputname)
    ...
    def plot_figure(self, data, traj, outputname, original, color):
        ...
        # 绘制percentage 图
        self.plot_ss_percentage(df, structure_values, original, outputname, color)
